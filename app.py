...
from flask import jsonify # Importe o modulo jsonify
...
class Livro(db.Model):
    ...
    def __init__(self, titulo, autor, categoria, ano,
editora="Sem Editora", ativo=False):
        self.titulo = titulo
        self.autor = autor
...
with app.app_context():
    ...
    # Adicionar cada livro à base de dados, se ainda não estiver presente
...
# Rota para a página inicial que lista todos os livros
...
# Rota para a página de adicionar novo livro
@app.route("/novo")
@login_required
def novo():
    return render_template("novo.html", titulo="Novo Livro")

# Rota para criar um novo livro no banco de dados
...
with app.app_context():
    db.create_all()  # Isso recriará a tabela User com a nova estrutura
